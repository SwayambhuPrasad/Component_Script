...
!(function (a, b) {
  ...
  function g(a, b, c) {
      ...
      if (typeof window !== i && m) {
        ...
        try {
          window.document.cookie =
            encodeURIComponent(m) + "=; expires=Thu, 01 Jan 1970 00:00:00 UTC";
        } catch (a) {}
      }
    }
    var j,
    ...
    b = null == b ? "WARN" : b;
    var m = "loglevel";
    "string" == typeof a ? (m += ":" + a) : "symbol" == typeof a && (m = void 0),
      (l.name = a),
      ...
      (l.setLevel = function (b, c) {
        if (
          ("string" == typeof b &&
            void 0 !== l.levels[b.toUpperCase()] &&
            (b = l.levels[b.toUpperCase()]),
          !("number" == typeof b && b >= 0 && b <= l.levels.SILENT))
        )
          throw "log.setLevel() called with invalid level: " + b;
        if (
          ((j = b), !1 !== c && e(b), d.call(l, b, a), typeof console === i && b < l.levels.SILENT)
        )
  ...
  var h = function () {},
    ...
    j =
      typeof window !== i &&
      typeof window.navigator !== i &&
      /Trident\/|MSIE /.test(window.navigator.userAgent),
    k = ["trace", "debug", "info", "warn", "error"],
    l = new g(),
    m = {};
  l.getLogger = function (a) {
    if (("symbol" != typeof a && "string" != typeof a) || "" === a)
