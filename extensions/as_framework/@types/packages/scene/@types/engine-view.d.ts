...
export interface EngineView {
  ...
  callSceneMethod<T extends keyof ISceneFacade>(
    methodName: T,
    params: Parameters<ISceneFacade[T]>,
    forced?: boolean,
    timeout?: boolean,
  ): Promise<ReturnType<typeof ISceneFacade[T]>>;
...
export interface FloatWindowOptions {
  ...
  ready?: (
    ...
    info: ScenePluginInfo,
    componentMap: { [type: string]: ScenePluginComponentInfo[] },
  ) => void;
  close?: Function;
  update?: Function;
  send?: Function;
