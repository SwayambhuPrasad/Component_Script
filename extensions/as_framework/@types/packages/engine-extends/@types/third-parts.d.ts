...
declare module "draco3dgltf" {
  ...
  namespace DecoderModule {
    ...
    export class Decoder {
      ...
      public GetAttributeInt8ForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
        attributeData: DracoInt8Array,
      ): void;

      public GetAttributeInt16ForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
        attributeData: DracoInt16Array,
      ): void;

      public GetAttributeInt32ForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
        attributeData: DracoInt32Array,
      ): void;

      public GetAttributeUInt8ForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
        attributeData: DracoUInt8Array,
      ): void;

      public GetAttributeUInt16ForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
        attributeData: DracoUInt16Array,
      ): void;

      public GetAttributeUInt32ForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
        attributeData: DracoUInt32Array,
      ): void;

      public GetAttributeFloatForAllPoints(
        geometry: Geometry,
        attribute: Attribute,
