System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Button, Node, Sprite, Color, find, AS, ReplicatedButton, ReplicatedUIDrag, UIDrag, UIDrop, ValidationEvent, ChangeBackground, CheckPrompt, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, SnapToSlot;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ValidationEvent = _unresolved_5.ValidationEvent;
    ...
    execute: function () {
      ...
      _export("SnapToSlot", SnapToSlot = (_dec = ccclass('SnapToSlot'), _dec2 = property({
        ...
        async _callForPromts() {
          if (this.chechstatus) {
            await this.backGround.getComponentInChildren(_crd && CheckPrompt === void 0 ? (_reportPossibleCrUseOfCheckPrompt({
              error: Error()
        ...
        _resetfeedback() {
          for (let i = 0; i < this.DragOptions.length; i++) this.DragOptions[i].node.children.forEach(child => {
            child.active = false;
          });
        }
...
//# sourceMappingURL=a9d1a77622b9cead449fcfb85b06bf03f53b6719.js.map