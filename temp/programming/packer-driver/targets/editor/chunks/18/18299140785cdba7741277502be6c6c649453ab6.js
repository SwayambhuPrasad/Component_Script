      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag, Index) {
          ...
          if (slot.replacedNode.length != 0) {
            ...
            slot.replacedNode[0].node.getComponent(UIOpacity).opacity = 0;
            slot.replacedNode[0].interactable = false;
...
//# sourceMappingURL=18299140785cdba7741277502be6c6c649453ab6.js.map