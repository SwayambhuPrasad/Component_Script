    ...
    execute: function () {
      ...
      _export("UIDrop", UIDrop = (_dec = ccclass("UIDrop"), _dec2 = requireComponent(UITransform), _dec3 = property({
        ...
        __isInside(worldPoint) {
          ...
          const localPoint = this._parentUiTransform.convertToNodeSpaceAR(v3(worldPoint.x, worldPoint.y, 0));

          let isInRect = (_this$_uiTransform$ge = (_this$_uiTransform = this._uiTransform) == null ? void 0 : _this$_uiTransform.getBoundingBox().contains(v2(localPoint.x, localPoint.y))) != null ? _this$_uiTransform$ge : false;
...
//# sourceMappingURL=19339a966f32ca65c2e728ad63c4271ede9fb9f5.js.map