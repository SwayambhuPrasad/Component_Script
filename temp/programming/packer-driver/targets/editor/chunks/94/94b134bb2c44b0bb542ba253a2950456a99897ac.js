        ...
        awake() {
          ...
          choiceButtons.forEach((btn, i) => {
            ...
            btn.node.on(Button.EventType.CLICK, async () => {
              this._selection[i] = i;
              this._selection[i] == -1 ? btn.node.children[0].active = true : btn.node.children[0].active = false; // console.log("running");
            });
          });
        }
...
//# sourceMappingURL=94b134bb2c44b0bb542ba253a2950456a99897ac.js.map