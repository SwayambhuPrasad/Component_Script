        ...
        _arrangeDraggable() {
          ...
          for (let i = 0; i < this.DragContainer.children.length; i++) {
            if (i < this.numberOfElementPerpage) {
              ...
              this.DragContainer.children[i].position = new Vec3(0, 200, 0); // this.DragContainer.children[i].setPosition.y = gridPositions[gridSelector][i][1];
            }
          }
        }
...
//# sourceMappingURL=6f3cfa537f7d9ffffd9429a7f8dad48005c3a54d.js.map