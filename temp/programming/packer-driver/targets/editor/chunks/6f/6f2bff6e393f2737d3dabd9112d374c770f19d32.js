System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, find, instantiate, Label, Layout, Prefab, _decorator, AS, UIView, ReplicatedButton, UIAnimationLibrary, debug, ChangeBackground, ValidationEvent, CheckPrompt, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, requireComponent, AnswerType, MCQ;
  ...
  function _reportPossibleCrUseOfCheckPrompt(extras) {
    _reporterNs.report("CheckPrompt", "../../../CheckPrompt", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CheckPrompt = _unresolved_8.CheckPrompt;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("MCQ", MCQ = (_dec = ccclass("MCQ"), _dec2 = property({
        ...
        async checkSelection() {
          ...
          if (isCorrect) await this.backGround.getComponentInChildren(_crd && CheckPrompt === void 0 ? (_reportPossibleCrUseOfCheckPrompt({
            error: Error()
          }), CheckPrompt) : CheckPrompt).showCorrect();else await this.backGround.getComponentInChildren(_crd && CheckPrompt === void 0 ? (_reportPossibleCrUseOfCheckPrompt({
            error: Error()
...
//# sourceMappingURL=6f2bff6e393f2737d3dabd9112d374c770f19d32.js.map