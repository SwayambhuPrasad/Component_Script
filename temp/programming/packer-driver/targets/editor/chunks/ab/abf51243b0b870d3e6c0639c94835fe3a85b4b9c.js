        ...
        awake() {
          ...
          choiceButtons.forEach((btn, i) => {
            btn.node.on(Button.EventType.CLICK, async () => {
              ...
              let node = instantiate(btn.node[i]);
              node.parent = this.node;
              node.position = this.node.position; // take i and get the image to add.
            });
          });
        }
...
//# sourceMappingURL=abf51243b0b870d3e6c0639c94835fe3a85b4b9c.js.map