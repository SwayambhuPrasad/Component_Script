System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Button, AS, ReplicatedButton, _dec, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, requireComponent, AnswerType, MCQ;
    ...
    execute: function () {
      ...
      _export("MCQ", MCQ = (_dec = ccclass('MCQ'), _dec(_class = (_class2 = class MCQ extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "optionLebel", _descriptor2, this);
        }
        ...
        checkSelection() {
          ...
          console.log("Running1", this.answer);
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "optionLebel", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=ab7eb3422c26937a63a277de773cf830c2569ec9.js.map