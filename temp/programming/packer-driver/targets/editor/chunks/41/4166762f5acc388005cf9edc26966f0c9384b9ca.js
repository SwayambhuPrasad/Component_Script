System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Button, Prefab, AS, UIPopup, ReplicatedButton, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, requireComponent, FIB;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("FIB", FIB = (_dec = ccclass('FIB'), _dec2 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        error: Error()
      }), UIPopup) : UIPopup), _dec3 = property(Prefab), _dec4 = property({
        type: String
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "optionLabel", _descriptor3, this);
        }
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "optionLabel", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=4166762f5acc388005cf9edc26966f0c9384b9ca.js.map