      ...
      _export("MCQ", MCQ = (_dec = ccclass("Swap"), _dec2 = property({
        ...
        _check() {
          ...
          _dragables.forEach((dragable, i) => {
            console.log(this.Answer.toString(), "comp", this.DragContainer.children[i].name);

            if (this.Answer.toString() === this.DragContainer.children[i].name) {
              dragable.node.getComponent(Sprite).color = new Color(0, 255, 0, 255);
            } else dragable.node.getComponent(Sprite).color = new Color(255, 0, 0, 255);
          });
        }
...
//# sourceMappingURL=4147a904a12fbe62038e50b95fcc0096356de739.js.map