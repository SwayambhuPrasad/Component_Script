    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _addComponent() {
          ...
          const slot = this.panel.getComponentsInChildren(_crd && UIDrop === void 0 ? (_reportPossibleCrUseOfUIDrop({
            error: Error()
          }), UIDrop) : UIDrop);
          slot.forEach(s => {
...
//# sourceMappingURL=dd0806a7bf26a2300d6feea38f0043e57b0ff5db.js.map