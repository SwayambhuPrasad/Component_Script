        ...
        _check() {
          ...
          _dragables.forEach((dragable, i) => {
            ...
            if (this.Answer[i].toString() === this.DragContainer.children[i].name) {
              ...
              console.log("wrong ans" + i);
              console.log(dragable.node.getComponent(Sprite).color);
              dragable.node.getComponent(Sprite).color = new Color(255, 0, 0, 255);
            }
          });
        }
...
//# sourceMappingURL=88fa3c5167584b47e826332513c6b28d9a24b3ea.js.map