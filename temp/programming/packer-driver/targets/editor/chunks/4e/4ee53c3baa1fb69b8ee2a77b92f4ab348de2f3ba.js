    ...
    execute: function () {
      ...
      _export("OptionButton", OptionButton = (_dec = ccclass("OptionButton"), _dec2 = requireComponent(UITransform), _dec3 = requireComponent(Button), _dec4 = property({
        ...
        _updatePopupPosition() {
          ...
          const canvasBounds = this.popup._parentCanvas.node._uiProps.uiTransformComp.getBoundingBox(); // Initially set anchor to top center.


          let anchorX = 0.5;
          let anchorY = 1.0; // Set the position Y as below the button box bounds.

          let popupWorldPosY = buttonWorldBounds.yMin; // Check if popupPositionY provides enough room for the entire popup to
        ...
        _createOptionsList() {
          ...
          for (let index = 0; index < this.optionDatas.length; index++) {
            ...
            const item = itemNode.getComponent(_crd && OptionItem === void 0 ? (_reportPossibleCrUseOfOptionItem({
              error: Error()
...
//# sourceMappingURL=4ee53c3baa1fb69b8ee2a77b92f4ab348de2f3ba.js.map