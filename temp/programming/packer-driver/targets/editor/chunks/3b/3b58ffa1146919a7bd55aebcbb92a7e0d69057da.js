System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, Node, Sprite, SpriteFrame, _decorator, AS, UIDrag, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, requireComponent, MCQ;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MCQ", MCQ = (_dec = ccclass("Swap"), _dec2 = property({
        ...
        _check() {
          const _dragables = this.DragContainer.getComponentsInChildren(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
          }), UIDrag) : UIDrag);
        ...
        _feedback(feedtype, dragable) {
          ...
          const colorarray = [color(0, 255, 0, 255), color(255, 0, 0, 255)];
...
//# sourceMappingURL=3b58ffa1146919a7bd55aebcbb92a7e0d69057da.js.map