      ...
      _export("MCQ", MCQ = (_dec = ccclass('MCQ'), _dec2 = property({
        ...
        lableAssigner() {
          ...
          mcqLable.forEach((btnLable, i) => {
            console.log("Running");
            if (this.optionLabel.length < i) btnLable.node.active = false;else btnLable.string = this.optionLabel[i];
          });
        }
...
//# sourceMappingURL=ad8842610c66d6cdc6a8b61822726d88818dec0d.js.map