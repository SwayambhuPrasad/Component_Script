        ...
        _arrangeDraggable() {
          ...
          for (let i = 0; i < this.DragContainer.children.length; i++) {
            if (i < this.numberOfElementPerpage) {
              ...
              this.DragContainer.children[i].setPosition(new Vec3(gridPositions[gridSelector][i][0], gridPositions[gridSelector][i][1])); // this.DragContainer.children[i].setPosition.y = gridPositions[gridSelector][i][1];
            }
          }
        }
...
//# sourceMappingURL=d67912346c9f9e04ea59c1a4b3656f72e3e6ab41.js.map