    ...
    execute: function () {
      ...
      _export("UIDrag", UIDrag = (_dec = ccclass("UIDrag"), _dec2 = requireComponent(UITransform), _dec3 = property({
        ...
        checkUIDrop() {
          ...
          this._checkUIDropInternal(v2(targetWorldPosition.x, targetWorldPosition.y)); // If valid UI Drop doesn't allow multiple drag's in them, reset.
        ...
        awake() {
          ...
          const currentPositionInBounds = this._parentCanvas.convertToNodeSpaceAR(this.node.worldPosition);
...
//# sourceMappingURL=fee66172a50f219d1c837dc04390d8f159bf8c7b.js.map