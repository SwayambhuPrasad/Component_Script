      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _onpopuphide() {
          ...
          this.DragContainer.children.forEach((draggable, i) => {
            validDrop.push(this.DragContainer.children[i].getComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
              error: Error()
...
//# sourceMappingURL=8d790574f07feb13de6c19d59c5c4e42a108d051.js.map