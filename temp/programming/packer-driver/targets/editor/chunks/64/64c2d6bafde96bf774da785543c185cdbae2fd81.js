System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Button, Label, Prefab, AS, UIAnimationLibrary, ReplicatedButton, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, requireComponent, AnswerType, MCQ;
      ...
      _export("MCQ", MCQ = (_dec = ccclass('MCQ'), _dec2 = property({
        ...
        insertChild() {
          for (let i = 0; i < this.optionLabel.length; i++) {
            let addchild = instantiate(this.option);
            addchild.parent = this.node.children[0];
          }
        }
...
//# sourceMappingURL=64c2d6bafde96bf774da785543c185cdbae2fd81.js.map