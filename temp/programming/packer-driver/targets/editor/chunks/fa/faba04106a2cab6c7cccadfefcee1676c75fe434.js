System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Component, Sprite, _decorator, AS, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, requireComponent, MCQ;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MCQ", MCQ = (_dec = ccclass('Swap'), _dec2 = property({
        ...
        type: Sprite
      }), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class MCQ extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=faba04106a2cab6c7cccadfefcee1676c75fe434.js.map