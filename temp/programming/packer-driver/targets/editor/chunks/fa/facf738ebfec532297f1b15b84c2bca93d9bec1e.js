  ...
  return {
    ...
    execute: function () {
      ...
      _export("MCQ", MCQ = (_dec = ccclass("Swap"), _dec2 = property({
        ...
        _check() {
          const dragables = this.DragContainer.getComponentsInChildren(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
          }), UIDrag) : UIDrag);
...
//# sourceMappingURL=facf738ebfec532297f1b15b84c2bca93d9bec1e.js.map