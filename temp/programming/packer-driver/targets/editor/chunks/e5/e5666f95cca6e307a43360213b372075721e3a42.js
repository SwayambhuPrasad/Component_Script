System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Button, AudioSourceComponent, Node, AS, ReplicatedButton, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Audio;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "922bc8evzhBarPHsoOMP9JC", "Audio", undefined);
      ...
      _export("Audio", Audio = (_dec = ccclass('Audio'), _dec2 = property(Button), _dec3 = property(Node), _dec(_class = (_class2 = class Audio extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "audioSrc", _descriptor2, this);
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "audioSrc", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=e5666f95cca6e307a43360213b372075721e3a42.js.map