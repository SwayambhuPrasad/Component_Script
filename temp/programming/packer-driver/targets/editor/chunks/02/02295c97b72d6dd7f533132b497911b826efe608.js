  ...
  return {
    ...
    execute: function () {
      ...
      Translations = class Translations {
        ...
        async _parseLanguagePhrases(text) {
          // @ts-ignore
          if (!Papa) Papa = (await _context.import("__unresolved_3")).default;
          const {
            parse
          } = Papa;
        ...
        async _initializePolyglot() {
          ...
          if (this._polyglotInstance) {
            ...
            // @ts-ignore
            if (!Polyglot) Polyglot = (await _context.import("__unresolved_4")).default;
...
//# sourceMappingURL=02295c97b72d6dd7f533132b497911b826efe608.js.map