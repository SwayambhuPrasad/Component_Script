System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function withHorizLine(state, node) {
    ...
    const lineHeight = parseFloat((_node$style$borderBot = (_node$style$borderBot2 = node.style.borderBottomWidth) == null ? void 0 : _node$style$borderBot2.replace("em", "")) != null ? _node$style$borderBot : "0") * state.em;
    const lineNode = new (_crd && HorizontalLineNode === void 0 ? (_reportPossibleCrUseOfHorizontalLineNode({
      error: Error()
  ...
  function withVertLine(state, node) {
    ...
    const sepHeight = parseFloat((_node$style$height$re = (_node$style$height = node.style.height) == null ? void 0 : _node$style$height.replace("em", "")) != null ? _node$style$height$re : "0") * state.em;
    const sepWidth = 0.05 * state.em;
    const sepVerticalAlign = parseFloat((_node$style$verticalA = (_node$style$verticalA2 = node.style.verticalAlign) == null ? void 0 : _node$style$verticalA2.replace("em", "")) != null ? _node$style$verticalA : "0") * state.em;
    const sepY = state.y - sepVerticalAlign;
    const lineNode = new (_crd && VerticalLineNode === void 0 ? (_reportPossibleCrUseOfVerticalLineNode({
      error: Error()
  ...
  function withBox(state, node, hasBorder) {
    ...
    const height = parseFloat((_node$style$height$re2 = (_node$style$height2 = node.style.height) == null ? void 0 : _node$style$height2.replace("em", "")) != null ? _node$style$height$re2 : "0") * state.em;
    const minWidth = state.em * 0.3 * 2;
    state.vlist.alignment = "center";
    const x = state.nextX;
    const box = new (_crd && BoxNode === void 0 ? (_reportPossibleCrUseOfBoxNode({
      error: Error()
  ...
  function _reportPossibleCrUseOfkatex(extras) {
    _reporterNs.report("katex", "./katex/katex.js", _context.meta, extras);
  }
      ...
      ClassStateMapping = class ClassStateMapping {
        ...
        vlist(state, node) {
          if (hasChildNodes(node) && hasChildNodes(node.children[0]) && node.children[0].children.length) {
            const vlist = new (_crd && VerticalList === void 0 ? (_reportPossibleCrUseOfVerticalList({
              error: Error()
        ...
        pstrut(state, node) {
          ...
          const height = parseFloat((_node$style$height$re3 = (_node$style$height3 = node.style.height) == null ? void 0 : _node$style$height3.replace("em", "")) != null ? _node$style$height$re3 : "0") * state.em;
          const tableRow = new (_crd && VerticalListRow === void 0 ? (_reportPossibleCrUseOfVerticalListRow({
            error: Error()
        ...
        base(state, node) {
          ...
          const strut = new (_crd && HPaddingNode === void 0 ? (_reportPossibleCrUseOfHPaddingNode({
            error: Error()
          ...
          const lastRow = state.vlist.last(); // lastRow.depth = depth;
        ...
        newline(state, node) {
          ...
          const strutHeight = (_strutBounds$height = strutBounds == null ? void 0 : strutBounds.height) != null ? _strutBounds$height : 0;
        ...
        arraycolsep(state, node) {
          ...
          const colWidth = parseFloat((_node$style$width$rep = (_node$style$width = node.style.width) == null ? void 0 : _node$style$width.replace("em", "")) != null ? _node$style$width$rep : "0") * state.em;
          const hPad = new (_crd && HPaddingNode === void 0 ? (_reportPossibleCrUseOfHPaddingNode({
            error: Error()
          }), HPaddingNode) : HPaddingNode)(state.classes);
        ...
        accent(state, _node, options) {
          ...
          const family = (_options$defaultSansS = options == null ? void 0 : options.defaultSansSerifText) != null ? _options$defaultSansS : "KaTeX_SansSerif";
        ...
        nulldelimiter(state) {
          ...
          const node = new (_crd && HPaddingNode === void 0 ? (_reportPossibleCrUseOfHPaddingNode({
            error: Error()
          }), HPaddingNode) : HPaddingNode)(state.classes);
...
//# sourceMappingURL=ee6db572024775266de1a6a738cf589554c39f28.js.map