  ...
  return {
    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _arrangeDraggable() {
          let offsetx = 0; //this.panel.position.x - this.popup.node.position.x;

          let offsety = 0; //this.panel.position.y - this.popup.node.position.y;
        ...
        _onpopuphide() {
          ...
          this._draggables.forEach((draggable, i) => {
            const inValidDrop = draggable.validUIDrop != null;
...
//# sourceMappingURL=3fcf65ffa016a48b749dc94165b6f45f697ad7ea.js.map