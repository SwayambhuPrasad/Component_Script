    ...
    execute: function () {
      ...
      _export("ReplicatedUIDrag", ReplicatedUIDrag = (_dec = ccclass("ReplicatedUIDrag"), _dec2 = requireComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
        ...
        _onDragMove(drag, isReplicated) {
          if (isReplicated) return;
          const delta = Vec3.subtract(v3(), drag.targetPosition, drag.previousTargetPosition); // throttle the event to avoid sending too many events.
...
//# sourceMappingURL=d5a0d7aee40d79ab30dedd3e34b5f34cdbb12db0.js.map