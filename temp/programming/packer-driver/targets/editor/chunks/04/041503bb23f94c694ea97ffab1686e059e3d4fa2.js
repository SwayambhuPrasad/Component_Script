    ...
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        const readBits = schema => stream => {
          const byte = readByte()(stream); // convert the byte to bit array
        ...
        const lzw = (minCodeSize, data, pixelCount) => {
          ...
          const pixelStack = new Array(MAX_STACK_SIZE + 1); // Initialize GIF data stream decoder.
        ...
        const decompressFrame = (frame, gct, buildImagePatch) => {
          ...
          const totalPixels = image.descriptor.width * image.descriptor.height; // do lzw decompression
...
//# sourceMappingURL=041503bb23f94c694ea97ffab1686e059e3d4fa2.js.map