System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, error, warn, classStateMapping, katex, State, styleStateMapping, HPaddingNode, SvgNode, TextNode, VerticalListRow, NodeData, VirtualNodeBuilder, _crd, IDENTIFIER_CLASS;
  ...
  function isSymbolNode(obj) {
    return obj instanceof (_crd && katex === void 0 ? (_reportPossibleCrUseOfkatex({
      error: Error()
    }), katex) : katex).__domTree.SymbolNode;
  }

  function isSvgNode(obj) {
    return obj instanceof (_crd && katex === void 0 ? (_reportPossibleCrUseOfkatex({
      error: Error()
    }), katex) : katex).__domTree.SvgNode;
  }
  ...
  function _reportPossibleCrUseOfIOptions(extras) {
    _reporterNs.report("IOptions", "./RenderingState", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      katex = _unresolved_4.default;
    }, function (_unresolved_5) {
      State = _unresolved_5.State;
    }, function (_unresolved_6) {
      styleStateMapping = _unresolved_6.styleStateMapping;
    }, function (_unresolved_7) {
      HPaddingNode = _unresolved_7.HPaddingNode;
      SvgNode = _unresolved_7.SvgNode;
      TextNode = _unresolved_7.TextNode;
      VerticalListRow = _unresolved_7.VerticalListRow;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("VirtualNodeBuilder", VirtualNodeBuilder = class VirtualNodeBuilder {
        ...
        build() {
          ...
          const row = new (_crd && VerticalListRow === void 0 ? (_reportPossibleCrUseOfVerticalListRow({
            error: Error()
          ...
          try {
            virtualDomTree = (_crd && katex === void 0 ? (_reportPossibleCrUseOfkatex({
              error: Error()
            }), katex) : katex).__renderToHTMLTree(this._latex, this._options).children[0];
          } catch (err) {
            if (err instanceof (_crd && katex === void 0 ? (_reportPossibleCrUseOfkatex({
              error: Error()
            }), katex) : katex).ParseError) {
              (_crd && error === void 0 ? (_reportPossibleCrUseOferror({
                error: Error()
              }), error) : error)(err.message);
            } else (_crd && error === void 0 ? (_reportPossibleCrUseOferror({
              error: Error()
            }), error) : error)(err);
        ...
        _extractClassDataFromNode(node) {
          ...
          node.classes.forEach(name => {
            if (name === IDENTIFIER_CLASS) {
              ...
              const index = this._enclosedClassIndexes[name] = (_this$_enclosedClassI = this._enclosedClassIndexes[name]) != null ? _this$_enclosedClassI : 0;
        ...
        _createMSpace() {
          if (this._state.mspace) {
            const mspace = new (_crd && HPaddingNode === void 0 ? (_reportPossibleCrUseOfHPaddingNode({
              error: Error()
        ...
        _createSvgNode(node) {
          ...
          const svgNode = new (_crd && SvgNode === void 0 ? (_reportPossibleCrUseOfSvgNode({
            error: Error()
        ...
        _createTextNode(node) {
          ...
          if (isSymbolNode(node) && node.text !== "​") {
            const state = this._state;
            const textNode = new (_crd && TextNode === void 0 ? (_reportPossibleCrUseOfTextNode({
              error: Error()
        ...
        _createItalicNode(node) {
          if (isSymbolNode(node)) {
            ...
            const italicNode = new (_crd && HPaddingNode === void 0 ? (_reportPossibleCrUseOfHPaddingNode({
              error: Error()
            }), HPaddingNode) : HPaddingNode)(this._state.classes);
...
//# sourceMappingURL=8b2d231d2d221ca373967f579e1ab7fbedb4920d.js.map