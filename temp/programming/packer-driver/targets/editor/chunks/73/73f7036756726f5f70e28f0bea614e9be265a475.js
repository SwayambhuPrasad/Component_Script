        ...
        _addComponent() {
          ...
          for (let i = 0; i < this.DragContainer.children.length; i++) {
            ...
            drag.node.on((_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
              ...
              dragCopy.parent.position = slot.node.position;
              console.log("copyPosition", dragCopy.parent.position);
              console.log("slotPosition", slot.node.position);
...
//# sourceMappingURL=73f7036756726f5f70e28f0bea614e9be265a475.js.map