      ...
      _export("MCQ", MCQ = (_dec = ccclass("Swap"), _dec2 = property({
        ...
        _check() {
          ...
          for (let j = 0; j < this.DragContainer.children.length; j++) {
            _position.push(this.DragContainer.children[0].getPosition().y);

            _position.sort();
          }

          _dragables.forEach((dragable, i) => {
            console.log(this.DragContainer.children[this.Answer[i]].position.y, "comp", _position[i]);

            if (this.DragContainer.children[this.Answer[i]].position.y == _position[i]) {
...
//# sourceMappingURL=24cedab5d6e16f70ae7e1320180d6e851dabce9a.js.map