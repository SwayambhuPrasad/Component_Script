        ...
        awake() {
          ...
          choiceButtons.forEach((btn, i) => {
            btn.node.on(Button.EventType.CLICK, async () => {
              ...
              _selectedOption.getComponent(UITransform).width = this.node.getComponent(UITransform).width; // take i and get the image to add.
            });
          });
        }
...
//# sourceMappingURL=07ab15f00e9ea52a91ca37fde895d5403656307b.js.map