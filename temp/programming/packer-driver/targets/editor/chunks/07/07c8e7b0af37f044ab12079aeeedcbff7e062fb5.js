System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "64053ZcslJNLY5DWRLagFce", "SelectAndMatch", undefined);
      ...
      _export("SelectAndMatch", SelectAndMatch = (_dec = ccclass('SelectAndMatch'), _dec2 = property(Layout), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(SpriteFrame), _dec9 = property(SpriteFrame), _dec(_class = (_class2 = class SelectAndMatch extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor(...args) {
          super(...args);
        ...
        awake() {
          ...
          for (let i = 0; i < this._correctAns.length / 2; i++) this._completedSet.push(false);
        ...
        _reset() {
          ...
          for (let i = 0; i < this._correctAns.length / 2; i++) this._completedSet[i] = false;
        }
...
//# sourceMappingURL=07c8e7b0af37f044ab12079aeeedcbff7e062fb5.js.map