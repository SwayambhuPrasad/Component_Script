      ...
      _export("MCQ", MCQ = (_dec = ccclass("MCQ"), _dec2 = property({
        ...
        checkSelection() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (isCorrect) yield _this2.backGround.getComponentInChildren(CheckPrompt).showCorrect();else yield _this2.backGround.getComponentInChildren(Checkrompt).showTryAgain();
...
//# sourceMappingURL=5b56d90335ba05add941427adf4608a981435b44.js.map