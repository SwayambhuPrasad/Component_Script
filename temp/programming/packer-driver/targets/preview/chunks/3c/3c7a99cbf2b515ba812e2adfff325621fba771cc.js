        ...
        _arrangeDraggable() {
          ...
          for (var i = 0; i < this.DragContainer.children.length; i++) {
            if (i < this.numberOfElementPerpage) {
              ...
              this.DragContainer.children[i].position = new Vec3(gridPositions[gridSelector][i][0], gridPositions[gridSelector][i][1], 0); // this.DragContainer.children[i].setPosition.y = gridPositions[gridSelector][i][1];
            }
          }
        }
...
//# sourceMappingURL=3c7a99cbf2b515ba812e2adfff325621fba771cc.js.map