System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Button, Prefab, Layout, Label, AS, UIPopup, ReplicatedButton, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, requireComponent, FIB;
      ...
      _export("FIB", FIB = (_dec = ccclass('FIB'), _dec2 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        ...
        awake() {
          ...
          this.popup.node.children[0].on(Button.EventType.CLICK, () => {
            this._onCrossClick();
          }); // const options= this.optionsContainer.getComponentsInChildren(Button);
          // options.forEach((opt, i) => {
          //   console.log("name"+opt.name)
          //    opt.node.on(Button.EventType.CLICK, this._optionSelection.bind, this)
          // });
...
//# sourceMappingURL=9e86e9bfb5b8a47bae13030c4d43b1ebf1024dba.js.map