    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          if (slot == null) return;
          console.log(slot.replacedNode, slot.dragsInside); // slot.node.destroyAllChildren();
          // const dragCopy = instantiate(slot.dragsInside);
...
//# sourceMappingURL=8833bc8cf0aced3327e4f5e1019e5e4e0acf64e7.js.map