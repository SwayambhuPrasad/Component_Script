System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, instantiate, Label, Layout, Prefab, _decorator, AS, ReplicatedButton, UIPopup, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, requireComponent, FIB;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("FIB", FIB = (_dec = ccclass("FIB"), _dec2 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        ...
        _clearOptions() {
          var options = this.optionsContainer.getComponentsInChildren(Button); //console.log(options.length)
...
//# sourceMappingURL=68970fcb805e23e509afd377ed6d9288cd5b3b31.js.map