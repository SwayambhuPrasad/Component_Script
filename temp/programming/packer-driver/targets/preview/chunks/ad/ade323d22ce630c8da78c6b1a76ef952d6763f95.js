System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, Node, Vec3, _decorator, AS, UIDrag, UIDrop, UIView, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, StoryPanel;
    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _addComponent() {
          ...
          for (var i = 0; i < this.panel.children.length - 1; i++) {
          ...
          for (var _i = 0; _i < this.DragContainer.children.length - 1; _i++) {
            _loop(_i);
          }
        ...
        _DragEnd(drag) {// const slot = drag.validUIDrop;
...
//# sourceMappingURL=ade323d22ce630c8da78c6b1a76ef952d6763f95.js.map