    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          if (slot == null) return;
          console.log(slot.replacedNode, slot.dragsInside, slot);
          ...
          slot.dragInside[0].node.getComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
...
//# sourceMappingURL=40dafa33bfef843b381f6d4c78ef17e48dd1378b.js.map