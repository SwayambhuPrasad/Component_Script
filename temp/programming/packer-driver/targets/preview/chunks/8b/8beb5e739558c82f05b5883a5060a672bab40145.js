    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          if (slot.replacedNode.length != 0) slot.replacedNode[0].node.active = true; //drag.interactable = false;
        }
...
//# sourceMappingURL=8beb5e739558c82f05b5883a5060a672bab40145.js.map