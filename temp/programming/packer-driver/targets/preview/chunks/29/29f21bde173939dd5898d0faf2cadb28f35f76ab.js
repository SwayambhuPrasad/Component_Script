System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Button, UITransform, Sprite, AS, UIPopup, ReplicatedButton, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, requireComponent, AddImage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AddImage", AddImage = (_dec = ccclass('AddImage'), _dec2 = requireComponent(Button), _dec3 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        error: Error()
      }), UIPopup) : UIPopup), _dec4 = property(Sprite), _dec(_class = _dec2(_class = (_class2 = class AddImage extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor() {
          super(...arguments);
        ...
        awake() {
          ...
          var insertButtonsComp = this.popup.node.children;
          insertButtonsComp.forEach((child, i) => {
            ...
            child.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              var _selectedOption = instantiate(child);
...
//# sourceMappingURL=29f21bde173939dd5898d0faf2cadb28f35f76ab.js.map