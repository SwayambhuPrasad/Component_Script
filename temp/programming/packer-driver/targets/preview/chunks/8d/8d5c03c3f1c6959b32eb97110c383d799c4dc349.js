System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Component, EventHandler, Intersection2D, Mat4, Node, PolygonCollider2D, rect, UITransform, v2, v3, Vec2, Vec3, _decorator, AS, UIDrop, findParentCanvas, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _class3, _crd, ccclass, property, disallowMultiple, requireComponent, DRAG_SPEED, matrixCached, worldMatrixCached, UIDrag;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIDrag", UIDrag = (_dec = ccclass("UIDrag"), _dec2 = requireComponent(UITransform), _dec3 = property({
        ...
        checkUIDrop() {
          this._checkUIDropInternal(v2(this.node.worldPosition.x, this.node.worldPosition.y)); // If valid UI Drop doesn't allow multiple drag's in them, reset.
        ...
        update(dt) {
          var currPosition = this.node.worldPosition;
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "enableResetPosition", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "enableResetPosition"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "target", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "target"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "usePolygonCollider", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "usePolygonCollider"), _class2.prototype)), _class2)) || _class) || _class) || _class));
...
//# sourceMappingURL=8d5c03c3f1c6959b32eb97110c383d799c4dc349.js.map