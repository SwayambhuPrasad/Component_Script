System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, Node, Vec3, _decorator, AS, debug, UIDrag, UIDrop, UIPopup, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, StoryPanel;
  ...
  function _reportPossibleCrUseOfUIPopup(extras) {
    _reporterNs.report("UIPopup", "db://as_framework/scripts", _context.meta, extras);
  }
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _addComponent() {
          ...
          for (var _i = 0; _i < this.DragContainer.children.length; _i++) {
            var drag = this.DragContainer.children[_i].addComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
              error: Error()
            }), UIDrag) : UIDrag);

            this._dragNodes.push(this.DragContainer.children[_i]);
        ...
        _arrangeDraggable() {
          var offsetx = 0; //this.panel.position.x - this.popup.node.position.x;

          var offsety = 0; //this.panel.position.y - this.popup.node.position.y;
        ...
        _onpopuphide() {
          ...
          this._draggables.forEach((draggable, i) => {
            var inValidDrop = draggable.validUIDrop != null;
            (_crd && debug === void 0 ? (_reportPossibleCrUseOfdebug({
              error: Error()
            }), debug) : debug)("Draggable " + draggable.node.name + " in valid drop?: " + inValidDrop);
            if (!inValidDrop) draggable.node.active = false;
          });
        }
...
//# sourceMappingURL=07786faea34fb7cf709473633fc8de6df54538af.js.map