    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          slot.__removeDrag(drag);

          slot.__addDrag(dragCopy.getComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
          }), UIDrag) : UIDrag));

          dragCopy.getComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
          }), UIDrag) : UIDrag).interactable = false; // dragCopy.parent = slot.node;
          // dragCopy.worldPosition = slot.node.worldPosition;
          // drag.reset();

          drag.interactable = false;
          drag.node.active = false;
          console.log(slot.replacedNode);
        }
...
//# sourceMappingURL=d158ca58a8e788fbbafb79d8945abfc7484e45e4.js.map