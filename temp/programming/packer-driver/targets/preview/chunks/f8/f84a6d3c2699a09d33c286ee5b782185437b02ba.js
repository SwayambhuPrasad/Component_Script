System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Button, AS, UIPopup, ReplicatedButton, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Definition;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dd548tdEZxMC7yXYRDKlKXx", "Definition", undefined);
      ...
      _export("Definition", Definition = (_dec = ccclass('Definition'), _dec2 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        error: Error()
      }), UIPopup) : UIPopup), _dec3 = property(Button), _dec(_class = (_class2 = class Definition extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=f84a6d3c2699a09d33c286ee5b782185437b02ba.js.map