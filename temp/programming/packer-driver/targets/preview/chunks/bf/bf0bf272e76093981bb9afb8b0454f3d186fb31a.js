System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, instantiate, Button, Prefab, Layout, Label, AS, UIPopup, ReplicatedButton, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, requireComponent, FIB;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("FIB", FIB = (_dec = ccclass('FIB'), _dec2 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        ...
        type: String
      }), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class FIB extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "check", _descriptor6, this);

          _initializerDefineProperty(this, "poplable", _descriptor7, this);
        }
        ...
        awake() {
          ...
          options.forEach((opt, i) => {
            ...
            opt.node.on(Button.EventType.CLICK, () => {
              ...
              seletion = i;
              this.poplable.getComponentInChildren(Label).string = this.optionLabel[i];
        ...
        _clearOptions() {
          ...
          options.forEach((opt, j) => {
            for (var i = 0; i < this.optionLabel.length - 1; i++) {
        ...
        _onCheckClick(options, seletion) {
          if (seletion != null) if (seletion == this.correctIndex) {
            ...
            this._button.node.getComponentInChildren(Label).string = options[seletion].getComponentInChildren(Label).string; //this._onCrossClick();
          } else options[seletion].node.children[2].active = true;
        }

        _optionSelection(index) {
          console.log("running", index);
          this.poplable.getComponent(Label).string = this.optionLabel[index];
        }
        ...
        lableAssigner() {
          var mcqLable = this.popup.node.children[1].getComponentsInChildren(Label);
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "check", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "poplable", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=bf0bf272e76093981bb9afb8b0454f3d186fb31a.js.map