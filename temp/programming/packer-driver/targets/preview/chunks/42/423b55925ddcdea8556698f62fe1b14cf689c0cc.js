System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Button, UITransform, AS, UIPopup, ReplicatedButton, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _crd, ccclass, property, requireComponent, AddImage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AddImage", AddImage = (_dec = ccclass('AddImage'), _dec2 = requireComponent(Button), _dec3 = requireComponent(_crd && ReplicatedButton === void 0 ? (_reportPossibleCrUseOfReplicatedButton({
        error: Error()
      }), ReplicatedButton) : ReplicatedButton), _dec4 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        error: Error()
      }), UIPopup) : UIPopup), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class AddImage extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        error: Error()
      }), AS) : AS)(Component) {
        constructor() {
          super(...arguments);
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "popup", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=423b55925ddcdea8556698f62fe1b14cf689c0cc.js.map