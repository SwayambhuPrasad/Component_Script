    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          if (slot.replacedNode.length != 0) slot.replacedNode[0].node.active = true; // drag.node.getComponent(UIDrag).reset();
...
//# sourceMappingURL=cd5f4e1dc40d0412c842bd3ec5478da5a865ee85.js.map