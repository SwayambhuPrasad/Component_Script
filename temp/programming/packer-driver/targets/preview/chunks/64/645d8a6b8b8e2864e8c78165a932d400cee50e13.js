System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Button, AS, UIPopup, _dec, _dec2, _dec3, _class, _class2, _descriptor, _crd, ccclass, property, requireComponent, AddImage;
    ...
    execute: function () {
      ...
      _export("AddImage", AddImage = (_dec = ccclass('AddImage'), _dec2 = requireComponent(Button), _dec3 = property(_crd && UIPopup === void 0 ? (_reportPossibleCrUseOfUIPopup({
        ...
        awake() {
          ...
          this._addEventListeners(); // const insertButtonsComp= this.popup.
          ...
          choiceButtons.forEach((btn, i) => {
            btn.node.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              var node = instantiate(btn.node);
              node.parent = _this.node;
              node.position = _this.node.position;
              console.log("running"); // take i and get the image to add.
            }));
          });
        }
...
//# sourceMappingURL=645d8a6b8b8e2864e8c78165a932d400cee50e13.js.map