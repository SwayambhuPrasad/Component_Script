        ...
        _loadGif() {
          ...
          try {
            fetch(this._url).then(res => res.arrayBuffer()).then(arrayBuffer => {
              var gifParsed = (_crd && gif === void 0 ? (_reportPossibleCrUseOfgif({
                error: Error()
              }), gif) : gif).parseGIF(arrayBuffer);
              var frames = (_crd && gif === void 0 ? (_reportPossibleCrUseOfgif({
                error: Error()
...
//# sourceMappingURL=5e4df46516032ce84c1ceacf42134463fa7a7c6f.js.map