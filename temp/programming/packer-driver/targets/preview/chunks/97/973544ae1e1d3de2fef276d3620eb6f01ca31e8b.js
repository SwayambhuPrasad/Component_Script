System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Director, director, EDITOR, SimpleEvent, debug, error, Translations, _crd, Polyglot, Papa, i18n;
    ...
    execute: function () {
      ...
      Translations = class Translations {
        ...
        _init() {
          ...
          return _asyncToGenerator(function* () {
            try {
              ...
              var phrases = yield _this._parseLanguagePhrases(text);
        ...
        _parseLanguagePhrases(text) {
          return _asyncToGenerator(function* () {
            // @ts-ignore
            if (!Papa) Papa = (yield _context.import("__unresolved_3")).default;
            var {
              parse
            } = Papa;
        ...
        _initializePolyglot() {
          ...
          return _asyncToGenerator(function* () {
            var phrases = _this2._languagePhrases[_this2._currentLanguage];

            if (phrases == null) {
              throw new Error("The phrases for the current language is not found.");
            }

            if (_this2._polyglotInstance) {
              _this2._polyglotInstance.replace(phrases);
            } else {
              // @ts-ignore
              if (!Polyglot) Polyglot = (yield _context.import("__unresolved_4")).default;
              _this2._polyglotInstance = new Polyglot({
                phrases: phrases,
                locale: _this2._currentLanguage,
                allowMissing: true,
...
//# sourceMappingURL=973544ae1e1d3de2fef276d3620eb6f01ca31e8b.js.map