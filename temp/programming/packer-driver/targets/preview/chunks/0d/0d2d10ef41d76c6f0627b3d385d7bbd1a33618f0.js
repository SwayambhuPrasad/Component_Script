System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, instantiate, Node, Vec3, _decorator, AS, UIDrag, UIView, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, StoryPanel;
    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          if (slot == null) return; //slot.node.destroyAllChildren();
          ...
          dragCopy.worldPosition = slot.node.worldPosition; //slot.dragInside[0].node.active = false;

          console.log(slot.replacedNode, slot.dragsInside[0], slot);
          drag.node.active = false;
          if (slot.replacedNode.length != 0) slot.replacedNode[0].node.active = true;
          drag.node.getComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
          }), UIDrag) : UIDrag).reset(); //drag.interactable = false;
        }
          ...
          for (var _i = 0; _i < pageGrouping.length; _i++) {
            for (var _j = 0; _j < pageGrouping[_i].length; _j++) {
              if (_i == pageNumber) {
                ...
                console.log(_i);
              } else pageGrouping[_i][_j].active = false;
            }
          }
        }
...
//# sourceMappingURL=0d2d10ef41d76c6f0627b3d385d7bbd1a33618f0.js.map