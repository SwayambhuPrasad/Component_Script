System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  function loadFonts(_ref) {
    ...
    return new Promise((resolve, _) => {
      ...
      (_crd && WebFont === void 0 ? (_reportPossibleCrUseOfWebFont({
        error: Error()
      }), WebFont) : WebFont).load(_extends({}, config, {
        classes: false,
  ...
  function loadAllFonts() {
    return _loadAllFonts.apply(this, arguments);
  }

  function _loadAllFonts() {
    _loadAllFonts = _asyncToGenerator(function* () {
      fontsLoadedEvent.on(() => {
        var _director$getScene;

        var labels = (_director$getScene = director.getScene()) == null ? void 0 : _director$getScene.getComponentsInChildren(Label);
      ...
      var fonts = yield (yield fetch("./font-data.json")).json();
      yield Promise.all(fonts.fontKits.map(font => loadFonts(font)));
      if (fonts.hasLatex) yield loadKatexFonts();
      fontsLoadedEvent.trigger();
    });
    return _loadAllFonts.apply(this, arguments);
  }
      ...
      _export("FontManager", FontManager = (_dec4 = ccclass("FontManager"), _dec5 = property(FontData), _dec4(_class4 = executeInEditMode(_class4 = (_class5 = class FontManager extends (_crd && AS === void 0 ? (_reportPossibleCrUseOfAS({
        ...
        onLoad() {
          ...
          return _asyncToGenerator(function* () {
            yield Promise.all(_this.fontKits.map(font => loadFonts(font)));
            fontsLoadedEvent.trigger();
          })();
        }
...
//# sourceMappingURL=28e07cbdd788cd7c48b96ef8ce04f60e34f7b714.js.map