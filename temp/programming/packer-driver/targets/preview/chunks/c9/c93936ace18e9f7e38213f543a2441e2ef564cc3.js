  ...
  return {
    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _onpopuphide() {
          var validDrop = function validDrop() {
            var getstatus = [];
            this.DragContainer.children.forEach((draggable, i) => {
              getstatus.push(draggable.getComponent(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
                error: Error()
              }), UIDrag) : UIDrag).get(validDrop));
            });
            return getstatus;
          };
...
//# sourceMappingURL=c93936ace18e9f7e38213f543a2441e2ef564cc3.js.map