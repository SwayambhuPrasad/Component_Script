    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          var dragCopy = instantiate(slot.node); //dragCopy.getComponent(UIDrag).destroy();

          dragCopy.parent = slot.node;
          dragCopy.name = slot.node.name;
          dragCopy.worldPosition = slot.node.worldPosition;
          slot.dragInside.node.active = false;
          slot.dragInside.reset();
...
//# sourceMappingURL=414343c58b582b4deb574befcecaabd1d4135e0b.js.map