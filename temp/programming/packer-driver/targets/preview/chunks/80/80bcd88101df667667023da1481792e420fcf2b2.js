  ...
  return {
    ...
    execute: function () {
      ...
      _export("BiDirectionalMap", BiDirectionalMap = class BiDirectionalMap {
        ...
        set(key, value) {
          var existingValue = this.forwardMap.get(key);
          if (existingValue != null) this.reverseMap.delete(existingValue);
          var existingKey = this.reverseMap.get(value);
        ...
        deleteKey(key) {
          var value = this.forwardMap.get(key);
        ...
        deleteValue(value) {
          var key = this.reverseMap.get(value);
...
//# sourceMappingURL=80bcd88101df667667023da1481792e420fcf2b2.js.map