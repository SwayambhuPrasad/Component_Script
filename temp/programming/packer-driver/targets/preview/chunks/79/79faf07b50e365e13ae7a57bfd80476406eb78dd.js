        ...
        _arrangeDraggable() {
          ...
          for (var i = 0; i < this.DragContainer.children.length; i++) {
            if (i < this.numberOfElementPerpage) {
              console.log("erfer", gridPositions[gridSelector][i][0], gridPositions[gridSelector][i][1]);
              this.DragContainer.children[i].setPosition(new Vec3(gridPositions[gridSelector][i][0], gridPositions[gridSelector][i][1], 0)); // this.DragContainer.children[i].setPosition.y = gridPositions[gridSelector][i][1];
            }
          }
        }
...
//# sourceMappingURL=79faf07b50e365e13ae7a57bfd80476406eb78dd.js.map