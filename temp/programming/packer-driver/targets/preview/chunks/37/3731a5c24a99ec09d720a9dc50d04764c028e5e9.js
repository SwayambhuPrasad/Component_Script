    ...
    execute: function () {
      ...
      _export("Screenshot", Screenshot = (_dec = ccclass("Screenshot"), _dec2 = property({
        ...
        onLoad() {
          ...
          var cameraNode = find(CAMERA_NAME, this._parentCanvas.node);
          ...
          if (!this._texture) {
            ...
            var canvasSize = view.getDesignResolutionSize();
        ...
        getImageURL(fullQuality) {
          var _this$_targetRect$get, _this$_targetRect;

          if (fullQuality === void 0) {
            fullQuality = true;
          }
          ...
          var data = (_crd && readPixels === void 0 ? (_reportPossibleCrUseOfreadPixels({
            error: Error()
...
//# sourceMappingURL=3731a5c24a99ec09d720a9dc50d04764c028e5e9.js.map