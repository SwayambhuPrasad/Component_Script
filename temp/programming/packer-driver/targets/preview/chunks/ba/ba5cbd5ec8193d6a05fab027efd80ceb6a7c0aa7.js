        ...
        awake() {
          ...
          this.clear.node.on(Button.EventType.CLICK, () => {
            if (this._iterator > 0) {
              ...
              for (var _i2 = 0; _i2 < this._options.length; _i2++) {
                if (temp == this._options[_i2].getComponentInChildren(Label).string) {
                  this._options[_i2].getComponent(Button).enabled = true;
                  this._options[_i2].getComponent(Sprite).color = new Color(255, 255, 255, 255);
                  break;
                }
              }
            }
...
//# sourceMappingURL=ba5cbd5ec8193d6a05fab027efd80ceb6a7c0aa7.js.map