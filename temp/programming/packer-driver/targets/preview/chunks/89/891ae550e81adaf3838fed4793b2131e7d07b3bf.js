      ...
      _export("MCQ", MCQ = (_dec = ccclass('MCQ'), _dec2 = property({
        ...
        lableAssigner() {
          ...
          mcqLable.forEach((btnLable, i) => {
            if (this.optionLabel.length < i) btnLable[i].node.parent.active = false;else btnLable.string = this.optionLabel[i];
          });
        }
...
//# sourceMappingURL=891ae550e81adaf3838fed4793b2131e7d07b3bf.js.map