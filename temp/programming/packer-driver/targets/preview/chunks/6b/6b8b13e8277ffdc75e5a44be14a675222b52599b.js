    ...
    execute: function () {
      ...
      _export("ColourRect", ColourRect = (_dec = ccclass("ColourRect"), _dec2 = requireComponent(UITransform), _dec3 = property({
        ...
        updateDraw() {
          ...
          var temp = this._fillColor.clone();

          var alpha = clamp(Math.round(this.node._uiProps.localOpacity * this._fillColor.a), 0, 255);
...
//# sourceMappingURL=6b8b13e8277ffdc75e5a44be14a675222b52599b.js.map