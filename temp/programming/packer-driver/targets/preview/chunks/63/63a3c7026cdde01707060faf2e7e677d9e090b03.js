System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Component, Sprite, _decorator, Node, SpriteFrame, AS, UIDrag, UIDrop, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, requireComponent, MCQ;
  ...
  function _reportPossibleCrUseOfUIDrop(extras) {
    _reporterNs.report("UIDrop", "db://as_framework/scripts/UIDrop", _context.meta, extras);
  }
      ...
      _export("MCQ", MCQ = (_dec = ccclass('Swap'), _dec2 = property({
        ...
        updateComponent() {
          for (var i = 0; i < this.parentImage.length; i++) {
            ...
            this.ParentImageContainer.children[i].addComponent(_crd && UIDrop === void 0 ? (_reportPossibleCrUseOfUIDrop({
              error: Error()
            }), UIDrop) : UIDrop);
          }
        }
...
//# sourceMappingURL=63a3c7026cdde01707060faf2e7e677d9e090b03.js.map