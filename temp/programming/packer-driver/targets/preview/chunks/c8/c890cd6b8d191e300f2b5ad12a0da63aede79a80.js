    ...
    execute: function () {
      ...
      _export("MatchTheFollowing", MatchTheFollowing = (_dec = ccclass("MatchTheFollowing"), _dec2 = requireComponent(Graphics), _dec3 = property(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
        ...
        checkPairs() {
          ...
          for (var index = 0; index < this.lineDragHandles.length; index++) {
            var drag = this.lineDragHandles[index];
        ...
        _updateDraw() {
          ...
          this.lineDragHandles.filter(drag => drag.validUIDrop).forEach(drag => {
            var xForm = this.node._uiProps.uiTransformComp;
            var localStart = xForm.convertToNodeSpaceAR(drag.resetScreenPoint);
            var localEnd = xForm.convertToNodeSpaceAR(drag.targetPosition);
...
//# sourceMappingURL=c890cd6b8d191e300f2b5ad12a0da63aede79a80.js.map