    ...
    execute: function () {
      ...
      _export("StoryPanel", StoryPanel = (_dec = ccclass("StoryPanel"), _dec2 = property({
        ...
        _DragEnd(drag) {
          ...
          if (slot == null) return;
          console.log(slot.replacedNode, slot.dragsInside);
          slot.node.destroyAllChildren();
          var dragCopy = instantiate(slot.dragsInside.node);
...
//# sourceMappingURL=5852b0e0aa75f8010085a5ade406559cb5c11a73.js.map