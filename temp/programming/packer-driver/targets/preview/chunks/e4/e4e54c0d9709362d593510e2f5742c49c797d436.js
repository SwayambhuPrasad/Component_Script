        ...
        _render() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var options = {
              output: "html",
              displayMode: true,
              baseSize: _this._baseSize,
              defaultTextColor: _this._defaultTextColor.toCSS(),
              macros: inputMacros,
              strict: false,
              trust: true
            };
            var nodeBuilder = new (_crd && VirtualNodeBuilder === void 0 ? (_reportPossibleCrUseOfVirtualNodeBuilder({
              error: Error()
            }), VirtualNodeBuilder) : VirtualNodeBuilder)(_this._latexSrc, options);
            var nodeData = yield nodeBuilder.build();
            ...
            _this._baseNodePositionOffset = v3(-rootX, rootY); // Create or get from pool

            _this._baseNode = (_baseNodePool$get = baseNodePool.get()) != null ? _baseNodePool$get : new Node("BaseNode");
            _this._baseNode.hideFlags |= CCObject.Flags.DontSave | CCObject.Flags.HideInHierarchy;
            _this._baseNode.layer = _this.node.layer;

            _this.node.addChild(_this._baseNode);

            var baseUiXform = (_this$_baseNode$getCo = _this._baseNode.getComponent(UITransform)) != null ? _this$_baseNode$getCo : _this._baseNode.addComponent(UITransform);
            baseUiXform.setAnchorPoint(0, 0);
            baseUiXform.setContentSize(rootWidth, rootHeight);

            _this._updateBaseNodePosition();

            _this._updateOverflow(); // Recursively create the node tree required.


            _this._convertRecursive(nodeData.rootNode, _this._baseNode);

            _this._updateInputNodes();
...
//# sourceMappingURL=e4e54c0d9709362d593510e2f5742c49c797d436.js.map