System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Button, Component, Node, _decorator, AS, UIDrag, UIDrop, UIPopup, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, StoryPanel;
        ...
        _arrangeDraggable() {
          ...
          for (var i = 0; i < this.DragContainer.children.length; i++) {
            if (i < this.numberOfElementPerpage) {
              this.DragContainer.children[i].getPosition().x = gridPositions[gridSelector][i][0];
              this.DragContainer.children[i].getPosition().y = gridPositions[gridSelector][i][1];
            }
          }
        }
...
//# sourceMappingURL=20960507e600632a9fa326883f83190483295295.js.map