System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Component, Enum, Intersection2D, PolygonCollider2D, UITransform, v2, v3, _decorator, AS, error, warn, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, disallowMultiple, requireComponent, BoundsType, DropBehaviour, UIDrop;
    ...
    execute: function () {
      ...
      _export("UIDrop", UIDrop = (_dec = ccclass("UIDrop"), _dec2 = requireComponent(UITransform), _dec3 = property({
        ...
        __removeDrag(drag) {
          ...
          if (index > -1) {
            var removed = this._dragsInside.splice(index, 1);
        ...
        __isInside(worldPoint) {
          ...
          var localPoint = this._parentUiTransform.convertToNodeSpaceAR(v3(worldPoint.x, worldPoint.y, 0));

          var isInRect = (_this$_uiTransform$ge = (_this$_uiTransform = this._uiTransform) == null ? void 0 : _this$_uiTransform.getBoundingBox().contains(v2(localPoint.x, localPoint.y))) != null ? _this$_uiTransform$ge : false;
...
//# sourceMappingURL=2639ca1f8c9fdfc2a53b8a755998f880f2e06ace.js.map