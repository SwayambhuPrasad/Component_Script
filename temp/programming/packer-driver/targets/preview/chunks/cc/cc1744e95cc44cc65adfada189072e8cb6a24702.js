        ...
        _arrangeDraggable() {
          ...
          for (var i = 0; i < this.DragContainer.children.length; i++) {
            if (i < this.numberOfElementPerpage) {
              this.DragContainer.children[i].position = new Vec3(gridPositions[gridSelector][i][0], gridPositions[gridSelector][i][1], 0);
            } else {
              this.DragContainer.children[i - this.numberOfElementPerpage].position = new Vec3(gridPositions[gridSelector][i][0], gridPositions[gridSelector][i][1], 0);
            }
          }
        }
...
//# sourceMappingURL=cc1744e95cc44cc65adfada189072e8cb6a24702.js.map