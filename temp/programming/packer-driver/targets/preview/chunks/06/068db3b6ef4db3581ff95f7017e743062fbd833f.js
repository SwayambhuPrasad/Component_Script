System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Color, Component, Node, Sprite, SpriteFrame, _decorator, AS, UIDrag, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, requireComponent, MCQ;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MCQ", MCQ = (_dec = ccclass("Swap"), _dec2 = property({
        ...
        _check() {
          var dragables = this.DragContainer.getComponentsInChildren(_crd && UIDrag === void 0 ? (_reportPossibleCrUseOfUIDrag({
            error: Error()
          }), UIDrag) : UIDrag);
        ...
        _feedback(feedtype, dragable) {
          var colorarray = [Color.GREEN, Color.RED];
...
//# sourceMappingURL=068db3b6ef4db3581ff95f7017e743062fbd833f.js.map