        ...
        awake() {
          ...
          choiceButtons.forEach((btn, i) => {
            btn.node.on(Button.EventType.CLICK, /*#__PURE__*/_asyncToGenerator(function* () {
              ...
              var node = instantiate(btn.node[i]);
              node.parent = _this.node;
              node.position = _this.node.position; // take i and get the image to add.
            }));
          });
        }
...
//# sourceMappingURL=6a40f1b5dfc27e1c31854a63c0100a06fa981dac.js.map