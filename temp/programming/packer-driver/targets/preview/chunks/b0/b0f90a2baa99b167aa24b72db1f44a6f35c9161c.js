    ...
    execute: function () {
      ...
      _export("MCQ", MCQ = (_dec = ccclass("MCQ"), _dec2 = property({
        ...
        awake() {
          ...
          this.node.children[0].addComponent(Button);
          this.node.children[0].addComponent(_crd && ReplicatedButton === void 0 ? (_reportPossibleCrUseOfReplicatedButton({
            error: Error()
          }), ReplicatedButton) : ReplicatedButton);
...
//# sourceMappingURL=b0f90a2baa99b167aa24b72db1f44a6f35c9161c.js.map